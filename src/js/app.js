    ...
    variables.lastName ? variables.lastName : "lastName"
          ...
          <ul class=${variables.socialMediaPosition || "right"}>
            <li><a href="https://twitter.com/${variables.twitter ||
              "JC_GONJ94"}"><i class="fab fa-twitter"></i></a></li>
            <li><a href="https://github.com/${variables.github ||
              "JCGJ94"}"><i class="fab fa-github"></i></a></li>
            <li><a href="https://linkedin.com/in/${variables.linkedin ||
              "jcgj94"}"><i class="fab fa-linkedin"></i></a></li>
              <li><a href="https://instagram.com/${variables.instagram ||
                "jc_gonj94"}"><i class="fab fa-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
